...
class SemestreController extends Controller
{
    ...
    public function store(SemestreRequest $request)
    {
        ...
        if ($sql == 1) {
            return back()->with('correcto', 'Unidad Registrado Exitosamente');
        } else {
    ...
    public function update(SemestreRequest $request)
    {
        ...
        if ($sql == 1) {
            return back()->with('correcto', 'Unidad Modificado Exitosamente');
        } else {
    ...
    public function destroy($id)
    {
        ...
        if ($sql == 1) {
            return back()->with('correcto', 'Unidad Eliminado Exitosamente');
        } else {
